...
def init_parser(alg):
    ...
    if alg == 'WOLP_DDPG':
        ...
        parser.add_argument('--max-episode', type=int, default=150, help='maximum #episode.')
        parser.add_argument('--test-episode', type=int, default=1000, help='maximum testing #episode.')
        parser.add_argument('--max-actions', default=50000, type=int, help='# max actions')
        ...
        parser.add_argument('--c-lr', default=0.002, type=float, help='critic net learning rate')
        ...
        parser.add_argument('--weight-decay', default=0, type=float, help='weight decay for L2 Regularization loss')
